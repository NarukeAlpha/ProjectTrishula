...
export default defineRailway(() => {
  ...
  const discord = service("discord", {
    ...
    env: {
      ...
      PORT: preserve(),
      TRISHULA_DURABLE_CONVERSATIONS_ENABLED: preserve(),
    },
  });
  ...
  const pi = service("pi", {
    ...
    env: {
      ...
      // Retain the existing dashboard name; the runtime reads EXA_API_KEY.
      EXA_AI_KEY: preserve(),
      EXA_CONTENTS_CONCURRENCY: "5",
      EXA_FINANCIAL_DATASETS_OWNER_DECISION: preserve(),
      EXA_FINANCIAL_DATASETS_MAX_COST_USD_PER_REQUEST: preserve(),
      EXA_MAX_CONTENT_PAGES_PER_EDITION: "24",
      EXA_MAX_COST_USD_PER_EDITION: preserve(),
      ...
      MARKET_DATA_PROVIDER_ID: preserve(),
      MARKET_RESEARCH_ENABLED: "true",
      NODE_ENV: preserve(),
      ...
      SERVICE_SHARED_SECRET: preserve(),
      TRISHULA_DURABLE_CONVERSATIONS_ENABLED: preserve(),
      TRISHULA_HOT_SESSION_IDLE_MS: preserve(),
      TRISHULA_HOT_SESSION_REUSE_ENABLED: preserve(),
      TRISHULA_LUNA_MAX_OUTPUT_TOKENS: preserve(),
      TRISHULA_LUNA_PROFILE_VERSION: preserve(),
      TRISHULA_LUNA_MODEL: preserve(),
      TRISHULA_LUNA_REASONING_EFFORT: preserve(),
      TRISHULA_LUNA_SERVICE_TIER: preserve(),
      TRISHULA_MAX_AUTONOMOUS_RECHECKS: preserve(),
      TRISHULA_MODEL_CONTEXT_WINDOW: preserve(),
      TRISHULA_NATIVE_COMPACTION_ENABLED: preserve(),
      TRISHULA_NATIVE_COMPACTION_LIVE_PROBE_ATTESTATION: preserve(),
      TRISHULA_PORTABLE_CHECKPOINTS_ENABLED: preserve(),
      TRISHULA_PERSONALITY_VERSION: preserve(),
      TRISHULA_RECENT_TAIL_TOKEN_BUDGET: preserve(),
      TRISHULA_RESEARCH_PACKET_MAX_BYTES: preserve(),
